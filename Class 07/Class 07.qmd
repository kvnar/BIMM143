...
There are 17 rows and 4 columns in my x date frame
...
This is contained in the `pca$rotation` onject - folks often call this the "loadings" or "contributions" to the PCS
