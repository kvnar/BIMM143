---
title: "Class 05: Data Visualization w/ ggplot"
...
- aes (how the columns of the data map to the plot aesthetics)
...
ggplot(cars) +
  ...
  labs(title = "Stopping distance of old cards",
...
```{r}
p + scale_colour_manual(values=c("blue","grey","magenta")) +
